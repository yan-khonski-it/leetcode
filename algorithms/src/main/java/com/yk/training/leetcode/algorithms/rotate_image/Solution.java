...
class Solution {
    ...
    public static void main(final String[] args) {
        ...
        System.out.println();
        final int[][] matrix3 = MatrixUtils.buildMatrix(3);
        solution.rotate(matrix3);
        MatrixUtils.printMatrix(matrix3);

        System.out.println();
        final int[][] matrix4 = MatrixUtils.buildMatrix(4);
        solution.rotate(matrix4);
        MatrixUtils.printMatrix(matrix4);

        System.out.println();
        final int[][] matrix5 = MatrixUtils.buildMatrix(5);
        solution.rotate(matrix5);
        MatrixUtils.printMatrix(matrix5);
    }
