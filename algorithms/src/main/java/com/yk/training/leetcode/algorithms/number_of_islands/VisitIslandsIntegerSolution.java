...
import com.yk.training.leetcode.algorithms.utils.FileUtils;

import java.util.LinkedList;

import static com.yk.training.leetcode.algorithms.utils.MatrixUtils.printMatrix;
...
public class VisitIslandsIntegerSolution {
    ...
    public static void main(String[] args) {
        ...
        int[][] worldMap = FileUtils.readMatrix(filename);
